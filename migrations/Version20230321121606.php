 ...
 */
final class Version20230321121606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , CONSTRAINT FK_CD632DF012469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CD632DF017542AC5 FOREIGN KEY (add_by_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
